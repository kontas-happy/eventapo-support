...
const items: FeatureWithTags[] = [
    ...
    },
    {
        ...
        "tags": ["チケット", "キャンセル", "返金", "払い戻し", "参加取り消し", "取り消し", "変更", "退出", "参加者管理", "予約変更", "手数料"],
        "details": "はい、チケットをキャンセルできます。\n申し込み期限内であれば、チケットページから申し込みをキャンセルすることができます。\n申し込み期限を過ぎた場合は、イベント主催者にお問い合わせください。\nチケットのキャンセルには手数料がかかる場合がございます。あらかじめご了承ください。",
        "link": "/fees",
        "linkText": "手数料について",
        "icon": {
